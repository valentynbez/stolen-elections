...
| Forensic Metric / Diagnostic Test | France 2022 (Democratic Control) | Russia 2026 (Competitive Autocracy) | Azerbaijan 2020 (Hegemonic Autocracy) |
| :--- | :--- | :--- | :--- |
| **Analyzed Polling Stations (UIKs / Bureaux)** | 64,650 | 83,798 | 5,571 |
| **Electorate Registered Voters** | 48,358,531 | 96,823,710 | 5,358,138 |
| **Official Turnout (%)** | 72.0% | 55.1% | 46.8% |
| **Incumbent / Regime Vote Share (%)** | 58.6% (Macron) | 56.6% (Regime) | 41.2% (YAP) |
| **OLS Regression Slope ($b$)** | **$-0.0636$** | **$+0.6348$** | **$+0.3949$** |
| **Pearson Correlation ($r$)** | **$-0.0413$** | **$+0.6533$** | **$+0.4133$** |
| **Coefficient of Determination ($R^2$)** | **$0.0017$** (Zero correlation) | **$0.4267$** (Extreme correlation) | **$0.1708$** (Strong correlation) |
| **Turnout Distribution Modality** | Unimodal Normal (Peak: ~78%) | Bimodal (Peaks: 43% and 75–100%) | Unimodal Skewed + 100% Spikes |
| **Near-Integer Precincts (% vs 10% expected)** | 10.24% (Matches uniform null) | 12.90% (Significant excess, $z = 20.9$) | 10.81% (Statistically elevated, $z = 2.01$) |
| **Multiples of 5% Precincts (% vs 2% expected)** | 2.08% (Matches uniform null) | 3.56% (Severe sawtooth spikes) | 2.75% ($4\sigma$ nationwide; **6.33% ($10\sigma$) in tail $\ge 60\%$**) |
| **Turnout Ceiling Artifacts** | 0 precincts at 100% | 1,483 precincts at 100% | 37 precincts at 100% |
| **Forensic Diagnosis / Regime Typology** | **Statistically Independent & Organic** | **Dual-Electorate / Ballot Box Stuffing** | **Administrative Protocol Fabrication** |
...
| **12. Cross-National Conclusions** | Triangulated comparative synthesis | Definitive statistical validation of electoral manipulation typologies across democratic and autocratic regimes |
...
├── notebooks/
│   └── stolen-elections.ipynb            # Fully executed 32-cell Jupyter Notebook with figures
├── writeups/
